...
const catalog = {
  fa: {
    ...
    'parsinegar.documents.sort-updated-desc': 'ویرایش: نو به کهنه',
    'parsinegar.documents.sort-updated-asc': 'ویرایش: کهنه به نو',
    'parsinegar.documents.sort-created-desc': 'ایجاد: نو به کهنه',
    'parsinegar.documents.sort-created-asc': 'ایجاد: کهنه به نو',
    'parsinegar.documents.sort-name': 'نام (الفبا)',
